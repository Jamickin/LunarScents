<template>
	...
	>
		<button
			...
			class="transition-all duration-300 fixed left-16 top-0 sm:hidden block"
		...
		<div
			class="flex sm:flex-row flex-col w-full h-full place-items-center justify-evenly"
		>
			<router-link
				to="/"
				@click="toggleMenu()"
		...
		<div
			class="w-full h-12 relative justify-center hidden sm:flex"
		>
			<div
				class="absolute transition-all duration-300 rounded-b-full xl w-48 justify-center"
				:class="{
