<template>
  <div
    ...
    <p class="text-center w-full text-lg">
      ...
      you.<br />
      Join us on this aromatic journey and introduce the
      pure scents of Lunar Scents to your valued customers.
      Let's chat, share ideas, and embark on a partnership
      that elevates the well-being of all. For inquiries,
      partnership proposals, or simply to learn more about
      our products, please feel free to reach out to us at
      andreajonelle@gmail.com I can't wait to connect and
      spread the essence of natural wellness together.
      <br />
      My warmest regards, Andrea Jõnelle Weichelt,
      <br />
